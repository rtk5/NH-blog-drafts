    ...
    <div className="min-h-screen">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden neuron-bg">
        ...
        <div 
          ...
          style={{
            backgroundImage: 'url("https://images.unsplash.com/photo-1624280433509-b01afeaf68e5?q=80&w=1315&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")'
          }}
        ></div>
